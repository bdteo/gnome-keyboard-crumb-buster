...
function icon_theme_error_quark(): any
/**
...
class BorderImage {
     ...
     */
    constructor(file: any, border_top: number, border_right: number, border_bottom: number, border_left: number, scale_factor: number) 
    /**
     * Creates a new #StBorderImage.
     * @constructor 
     * @param file a #GFile
     ...
     * @returns a new #StBorderImage.
     */
    static new(file: any, border_top: number, border_right: number, border_bottom: number, border_left: number, scale_factor: number): BorderImage
}
...
interface Clipboard {
     ...
     */
    set_content(type: ClipboardType, mimetype: string | null, bytes: any): void
    /**
...
interface Icon {
     ...
     */
    set_fallback_gicon(fallback_gicon: any | null): void
    /**
...
interface IconInfo {
     ...
     */
    load_icon_async(cancellable: any | null, callback: any | null): void
     ...
     */
    load_icon_async(cancellable: any | null): globalThis.Promise<any>
    /**
     ...
     */
    load_symbolic(colors: IconColors): [ /* returnType */ any, /* was_symbolic */ boolean ]
    /**
     ...
     * @param callback a #GAsyncReadyCallback to call when the     request is satisfied
     */
    load_symbolic_async(colors: IconColors, cancellable: any | null, callback: any | null): void
     ...
     * @returns A Promise of: the rendered icon; this may be a newly     created icon or a new reference to an internal icon, so you must     not modify the icon. Use g_object_unref() to release your reference     to the icon.
     */
    load_symbolic_async(colors: IconColors, cancellable: any | null): globalThis.Promise</* was_symbolic */ boolean>
    /**
     * Finishes an async icon load, see st_icon_info_load_symbolic_async().
     * @param res a #GAsyncResult
     * @returns the rendered icon; this may be a newly     created icon or a new reference to an internal icon, so you must     not modify the icon. Use g_object_unref() to release your reference     to the icon.
     */
    load_symbolic_finish(res: any): [ /* returnType */ any, /* was_symbolic */ boolean ]
}
...
interface IconTheme {
     ...
     */
    load_icon(icon_name: string | null, size: number, flags: IconLookupFlags): any | null
    /**
     ...
     * @returns the rendered icon; this may be     a newly created icon or a new reference to an internal icon, so     you must not modify the icon. Use g_object_unref() to release     your reference to the icon. %NULL if the icon isn’t found.
     */
    load_icon_for_scale(icon_name: string | null, size: number, scale: number, flags: IconLookupFlags): any | null
    /**
     ...
     */
    lookup_by_gicon(icon: any, size: number, flags: IconLookupFlags): IconInfo | null
    /**
     * Looks up an icon and returns a #StIconInfo containing information
     ...
     * @returns a #StIconInfo containing     information about the icon, or %NULL if the icon wasn’t     found. Unref with g_object_unref()
     */
    lookup_by_gicon_for_scale(icon: any, size: number, scale: number, flags: IconLookupFlags): IconInfo | null
    /**
     * Looks up a named icon and returns a #StIconInfo containing
     * information such as the filename of the icon. The icon
     * can then be rendered into a pixbuf using
...
module TextureCache {
    ...
    interface TextureFileChangedSignalCallback {
        ($obj: TextureCache, file: any): void
    }
...
interface TextureCache {
     ...
     * @returns A new #GIcon
     */
    bind_cairo_surface_property(object: any, property_name: string | null): any
    /**
     * Create a #GIcon from `surface`.
     * @param surface A #cairo_surface_t
     * @returns A new #GIcon
     */
    load_cairo_surface_to_gicon(surface: any): any
    /**
     ...
     */
    load_file_async(file: any, available_width: number, available_height: number, paint_scale: number, resource_scale: number): any
    /**
     ...
     */
    load_file_to_cairo_surface(file: any, paint_scale: number, resource_scale: number): any
    /**
     ...
     */
    load_gicon(theme_node: ThemeNode | null, icon: any, size: number, paint_scale: number, resource_scale: number): any | null
    /**
     ...
     */
    load_sliced_image(file: any, grid_width: number, grid_height: number, paint_scale: number, resource_scale: number, load_callback: any | null): any
    /**
    ...
    emit(sigName: "texture-file-changed", file: any, ...args: any[]): void
}
...
class Theme {
    ...
    constructor(application_stylesheet: any, theme_stylesheet: any, default_stylesheet: any) 
    static new(application_stylesheet: any, theme_stylesheet: any, default_stylesheet: any): Theme
}
...
interface ThemeNode {
     ...
     */
    get_url(property_name: string | null): any | null
    /**
     ...
     * @returns %TRUE if the property was found in the properties for this  theme node (or in the properties of parent nodes when inheriting.)
     */
    lookup_url(property_name: string | null, inherit: boolean): [ /* returnType */ boolean, /* file */ any ]
    /**
...
interface ThemeNodePaintState {
    ...
    init(): void
    invalidate(): void
    invalidate_for_file(file: any): boolean
