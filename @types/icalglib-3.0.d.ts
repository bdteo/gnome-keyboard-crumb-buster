...
// WARN: Dependency not found: 'GLib-2.0'
...
class Attach extends Object {
     ...
     */
    static new_from_bytes(bytes: any): Attach
    /**
     ...
     * @returns The newly created #ICalAttach
     */
    static new_from_data(data: string | null, free_fn: any | null): Attach
    /**
...
interface Object {
     ...
     */
    add_depender(depender: any): void
    /**
     ...
     * @param depender a #GObject depender
     */
    remove_depender(depender: any): void
    /**
     ...
     */
    set_native_destroy_func(native_destroy_func: any): void
    /**
